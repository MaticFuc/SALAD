...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FG Mask Creator")
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        default=["breakfast_box", "juice_bottle", "pushpins", "screw_bag", "splicing_connectors"]
    )
